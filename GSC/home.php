...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.html">SUPDECO CAMPUS THIES <br>WELCOME !!!</a></div>
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="profs.php" class="nav-link">Professeurs</a></li>
                <li><a href="etudiants.php" class="nav-link">Etudiants</a></li>
    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('images/azerty.jpeg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">Welcome to Classroom Management</h1>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Bienvenue dans le site de Gestion de salle de classe de SUPDECO campus THIES. Ce site a pour but d'organiser les salles de classes en foncionde la disponibilite </p>.</p>
            ...
            <form action="emplois.php" method="POST" class="form-box">
                <a href="" class="btn btn-primary" style="color: yellow;">ETUDIANTS</a>
                <a href="" class="btn btn-primary" style="color: yellow;">PROFS</a>
                <a href="" class="btn btn-primary" style="color: yellow;">ADMIN</a>
                                <h3 class="h4 text-black mb-4" style="text-align: center; margin-top: 27px">S'identifier</h3>
                                ...
                                <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-pill" name="submit" style="color: yellow;" value="Sign up" >
                                </div>
                </form>
      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 mb-5 text-center"  data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">L'ADMINISTRATION</h2>
          </div>
        </div>
        ...
        <form action="" method="POST">
            <table class="tbl-30">
                <tr>
                    <td>identifiant:</td>
                    <td><input type="text" name="ID" placeholder="ENTRER VOTRE ID"></td>
                </tr>
                ...
                <tr>
                    <td>PRENOM: </td>
                    <td><input type="text" name="PRENOM" placeholder="ENTRER VOTRE PRENOM !"></td>
                </tr>
                <tr>
                    <td>POSTE </td>
                    <td><input type="text" name="POSTE" placeholder="VOTRE POSTE"></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <input type="submit"  value="VAS-Y" class="btn-secondary" style="text-align: center;">
